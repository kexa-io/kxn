...
Un POC fonctionnel existe à `/path/to/icl/` (projet ICL — Infrastructure Configuration Language). Ce POC implémente :
...
Le code source Kexa est à `/path/to/kexa/`. Fichiers clés :
